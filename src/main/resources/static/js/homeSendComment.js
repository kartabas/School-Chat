const allCommentsUnderPost = "https://localhost:8080/home/comment/postcomments/"; // Must post ID be added to the end of the URL

const saveCommentUnderPost = "https://localhost:8080/home/comment/savecomment";
const profileAccountInfo = "https://localhost:8080/profile/"; // Must user ID be added to the end of the URL

const deleteCemmentUnderPost = "https://localhost:8080/home/comment/delete/"; // Must comment ID be added to the end of the URL
